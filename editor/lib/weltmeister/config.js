ig.module(
	...
	.defines(function () {
		...
		wm.config = {
			...
			'collisionTiles': {
				'path': 'editor/lib/weltmeister/collisiontiles-64.png',
				'tilesize': 64
			},
			...
			// to change these.
			'api': {
				'save': 'editor/lib/weltmeister/api/save.php',
				'browse': 'editor/lib/weltmeister/api/browse.php',
				'glob': 'editor/lib/weltmeister/api/glob.php'
			}
		};
